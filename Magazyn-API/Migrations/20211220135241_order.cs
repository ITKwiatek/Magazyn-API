        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticleNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    OrderingNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Supplier = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    SAP = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateToWarehouse = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateRelease = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateToEP = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Releases_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReleaseItems", x => new { x.ReleaseId, x.OrderItemId });
                    table.ForeignKey(
                        name: "FK_ReleaseItems_OrderItems_OrderItemId",
