...
namespace Magazyn_API.Migrations
{
    ...
    [Migration("20220414100537_fixed orderNr length2 (60)")]
    partial class fixedorderNrlength260
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Magazyn_API.Model.Order.GroupModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Magazyn_API.Model.Order.Device", b =>
                {
                    b.HasOne("Magazyn_API.Model.Order.GroupModel", "Group")
                        .WithMany("Devices")
